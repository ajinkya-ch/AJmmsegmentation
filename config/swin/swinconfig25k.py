...
data = dict(
    ...
    train=dict(
        ...
        split='/global/homes/a/aj2000/vtfs/splits/train_exp1_25k.txt'),
    val=dict(
        type='FiberDataset',
        ...
        split='/global/homes/a/aj2000/vtfs/splits/val_exp1_5k.txt'),
    test=dict(
        type='FiberDataset',
...
runner = dict(type='IterBasedRunner', max_iters=31250)

checkpoint_config = dict(
    by_epoch=False, interval=31250, meta=dict(CLASSES=2, PALETTE=None))

evaluation = dict(interval=100, metric=['mIoU', 'mDice'], pre_eval=True)
work_dir = '/global/cfs/projectdirs/m636/AJ/p1_models/swin/swin_25000_bsize2'
seed = 0
gpu_ids = range(0, 4)