#SWIN TINY DEFAULT CONFIG FROM PAPER https://huggingface.co/docs/transformers/model_doc/swin
...
work_dir = '/global/cfs/projectdirs/m636/AJ/p1_models/swin/swin_12500_bsize2'
seed = 0
gpu_ids = range(0, 4)